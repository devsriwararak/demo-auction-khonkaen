    ...
    const handleSave = async () => {
        try {
            ...
            const res = await axios.post(
                `${process.env.NEXT_PUBLIC_API_URL}/api/product/unit/add`,
                sendData,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
        ...
        try {
            ...
            if (confirm) {
                const res = await axios.delete(
                    `${process.env.NEXT_PUBLIC_API_URL}/api/product/unit/${id}`,
                    {
                        headers: {
                            Authorization: `Bearer ${token}`,
                        },
